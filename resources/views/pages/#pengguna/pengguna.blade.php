                   ...
                   <div class="card">
                     <div class="card-header">
                       ...
                       <div class="card-tools">
                        <a href="{{ route('formPengguna') }}" class="btn btn-outline-success btn-sm">Tambah Data Pengguna</a> 
                           ...
                           <thead>
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <form action="{{ route('deletePengguna', $key->id_pengguna) }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
