                   ...
                   <div class="card">
                     <div class="card-header">
                       ...
                       <div class="card-tools">
                        <a href="{{ route('formTenagaMedis') }}" class="btn btn-outline-success btn-sm">Tambah Data Tenaga Medis</a> 
                         ...
                         <table id="example1" class="table table-bordered table-striped">
                           <thead>
                             <tr>
                                ...
                                <th scope="col">ID Tenaga Medis</th> 
                                <th scope="col">Nama Tenaga Medis</th>
                             ...
                             <tbody>
                              ...
                              $no = 1;   
                              @endphp
                              @foreach ($tenagamedis as $key)
                              <tr>
                                <th scope="row">{{ $no++ }}</th>
                                <td>{{ $key->id_tenagamedis }}</td>
                                <td>{{ $key->Nama_Tenagamedis }}</td>
                                <td>
                                  <a href="#" class="btn btn-info btn-sm mx-1" >
                                    <i class="fas fa-edit"></i>
                                  </a>
                                  <form action="{{ route('deleteTenagaMedis', $key->id_tenagamedis) }}" method="post" class="d-inline">
                                      @method('delete')
                                      @csrf
